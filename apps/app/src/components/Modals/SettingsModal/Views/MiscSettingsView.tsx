...
export const MiscSettingsView = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-6'>
      <span className='text-lg font-semibold text-pt-purple-50 md:text-xl'>Other settings</span>

      <SettingToggle
        onChange={(checked) => setIsPermitDepositsDisabled(!checked)}
        checkedContent={'Permit approvals are enabled'}
        uncheckedContent={'Permit approvals are disabled'}
